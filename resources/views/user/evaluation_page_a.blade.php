...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Self-Evaluation Part A') }}</div>
                ...
                <div class="card-body">
                    ...
                    <p>Complete Part A by selecting <u><strong>one word on each line</strong></u> that <strong>most</strong> describes you.</p>
                    <p>You must <u><strong>select only one word</strong></u>.  √</p>


                    <form action="{{ route('post.evaluation-part-a') }}" method="post">
                    @csrf
